...
private async addPropietyText(){
  ...
  this.writeText(`Consta de ${pages.length+1} hojas selladas y firmadas en papel Sellado No. 1 hasta ${pages.length+1}`, xPosition , yPositionCurrent, currentPage, this.font);  
}
